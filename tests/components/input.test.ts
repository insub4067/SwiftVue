...
describe('TextField', () => {
  ...
  it('emits update:modelValue on input', async () => {
    const wrapper = mount(STextField, { props: { modelValue: '' } })
  ...
  it('applies placeholder', () => {
    const wrapper = mount(STextField, { props: { placeholder: 'Type here' } })
    expect(wrapper.find('input').attributes('placeholder')).toBe('Type here')
  })

  it('applies disabled state', () => {
    const wrapper = mount(STextField, { props: { disabled: true } })
    expect(wrapper.find('input').attributes('disabled')).toBeDefined()
  })

  it('applies roundedBorder style', () => {
    const wrapper = mount(STextField, { props: { textFieldStyle: 'roundedBorder' } })
