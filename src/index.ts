...
export { default as NavigationBackButton } from './components/navigation/NavigationBackButton.vue'
...
export type { NavigationBackButtonProps } from './components/navigation/NavigationBackButton.vue'
